...
class MetaDataset(Dataset):
    def __init__(self, x_transformer=None, y_transformer=None, task_descriptor_transformer=None):
...
class MetaRegressionDataset(MetaDataset):
    ...
    def __init__(self, tasks_filenames, x_transformer=None, y_transformer=None, task_descriptor_transformer=None,
                 max_examples_per_episode=None, max_test_examples=None, is_test=False, seed=42):
        super(MetaRegressionDataset, self).__init__(x_transformer, y_transformer, task_descriptor_transformer)
    ...
    def __getitem__(self, i):
        ...
        if self.is_test:
            k = self.max_examples_per_episode
