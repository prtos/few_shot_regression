...
if __name__ == '__main__':
    ...
    parser.add_argument('--outdir', default='results/test3', type=str, help='The name of the output directory for the experiments')
    parser.add_argument('--algos',
                        default=['metagp_sk'],  # ['hyperkrr', 'metakrr', 'multitask', 'snail', 'mann', 'maml'],
                        type=str, nargs='+',
                        choices=['metakrr_mk', 'metakrr_sk', 'metagp_mk', 'metagp_sk', 'multitask', 'snail', 'mann', 'maml', 'deep_prior'],
